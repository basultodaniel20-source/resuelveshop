<template>
  <section class="carrito-page">
    <div class="page-head">
      <div>
        <p class="eyebrow">ResuelveShop · Internacional</p>
        <h1>Tu carrito</h1>
        <p class="muted">
    ...
    <div v-if="!carrito.length" class="empty">
      ...
      <router-link class="btn primary" to="/internacional/catalogo">
        Ir al catálogo
      </router-link>
    </div>
    ...
    <div v-else class="layout">
      <div class="itemsWrap">
        <transition-group name="fade" tag="div" class="itemsList">
          ...
          >
            <router-link
              :to="`/internacional/producto/${item.id}`"
              class="thumb"
            >
      ...
      <aside class="summaryCard">
        ...
        <router-link class="btn primary full" to="/internacional/checkout">
          Finalizar pedido
        </router-link>

        <router-link class="btn ghost full" to="/internacional/catalogo">
          Seguir comprando
        </router-link>
      </aside>
    </div>
    ...
    <div v-if="carrito.length" class="mobileCheckoutBar">
      ...
      <router-link class="mobileBtn" to="/internacional/checkout">
        Finalizar
      </router-link>
    </div>
  </section>
